 ...
 * [RegistrationMethodFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [RegistrationMethodFragment.newInstance] factory method to
...
class RegistrationMethodFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_registration_method, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment RegistrationMethodFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                RegistrationMethodFragment().apply {
